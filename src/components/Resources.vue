  ...
  <div class="w-full h-full flex flex-col gap-8">
    ...
    <div class="py-4 flex justify-between border-t-[2px] border-[#f2f2f2] mt-8">
      ...
      <button
        ...
        "
        @click="saveStepTwo"
        class="border-[1px] cursor-pointer disabled:bg-[#0050FF1A] disabled:border-[1px] disabled:border-[#00000000] text-center h-[38px] rounded-md focus:border-[2px] focus:border-[#DAE5FF] hover:bg-[#0854FD] w-[67px] font-normal disabled:text-[] text-[11.9px] text-white bg-[#2563EB]"
      >
        Next
      </button>
    </div>
